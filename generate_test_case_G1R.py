...
# TEST_CASE_SEQUENCE = ['T551.R'] # SUBMITTED
# TEST_CASE_SEQUENCE = ['T551.R', 'T201.W'] #ACCEPTED
TEST_CASE_SEQUENCE = ['T551.R', 'T201.W', 'T213.W'] #DEFERRED !!! CHECK THE DATES of T213W_data_items
# TEST_CASE_SEQUENCE = ['T551.R', 'T211.R'] #CANCELLED
# TEST_CASE_SEQUENCE = ['T551.R', 'T202.W'] #REJECTED
# TEST_CASE_SEQUENCE = ['T551.R', 'T202.W', 'T210.R'] #RESUBMITTED 
# TEST_CASE_SEQUENCE = ['T551.R', 'T201.W', 'T203.W'] #INFOREQST
# TEST_CASE_SEQUENCE = ['T551.R', 'T201.W', 'T203.W', 'T204.R'] # INFOPROVD
# TEST_CASE_SEQUENCE = ['T551.R', 'T201.W', 'T222.W'] # COMPLETED
# TEST_CASE_SEQUENCE = ['T551.R', 'T201.W', 'T203.W', 'T204.R', 'T222.W', 'T208.R'] #CLOSED
# TEST_CASE_SEQUENCE = ['T551.R', 'T551.R', 'T201.W', 'T551.R', 'T211.R', 'T551.R', 'T202.W', 'T551.R', 'T202.W', 'T210.R', 'T551.R', 'T201.W', 'T203.W', 'T551.R', 'T201.W', 'T222.W']
...
def generate_test_case_G1R(loop_times):
    new_filename = ''
    for a in range(loop_times):
        ...
        for i in range(TEST_CASE_LENGTH):
            ...
            if ws11.cell(row=i+4+(a*TEST_CASE_LENGTH), column=5).value == 'T551.R':
...
generate_test_case_G1R(max_loop)