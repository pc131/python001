...
TEST_CASE_SEQUENCE = ['T505.R'] # SUBMITTED
# TEST_CASE_SEQUENCE = ['T505.R', 'T201.W'] #ACCEPTED
# TEST_CASE_SEQUENCE = ['T505.R', 'T211.R'] #CANCELLED
# TEST_CASE_SEQUENCE = ['T505.R', 'T202.W'] #REJECTED
# TEST_CASE_SEQUENCE = ['T505.R', 'T202.W', 'T210.R'] #RESUBMITTED
# TEST_CASE_SEQUENCE = ['T505.R', 'T201.W', 'T203.W'] #INFOREQST
# TEST_CASE_SEQUENCE = ['T505.R', 'T201.W', 'T203.W', 'T204.R'] # INFOPROVD
# TEST_CASE_SEQUENCE = ['T505.R', 'T201.W', 'T222.W'] # COMPLETED
# TEST_CASE_SEQUENCE = ['T505.R', 'T201.W', 'T203.W', 'T204.R', 'T222.W', 'T208.R'] #CLOSED
# TEST_CASE_SEQUENCE = ['T505.R', 'T505.R', 'T201.W', 'T505.R', 'T211.R', 'T505.R', 'T202.W', 'T505.R', 'T202.W', 'T210.R', 'T505.R', 'T201.W', 'T203.W', 'T505.R', 'T201.W', 'T222.W']
...
def generate_test_case_F4R(loop_times):
    new_filename = ''
    for a in range(loop_times):
        ...
        for i in range(TEST_CASE_LENGTH):
            ...
            if ws11.cell(row=i+4+(a*TEST_CASE_LENGTH), column=5).value == 'T505.R':
...
generate_test_case_F4R(max_loop)