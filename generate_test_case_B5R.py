...
TEST_CASE_SEQUENCE = ['T351.R'] # SUBMITTED
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W'] #ACCEPTED
# TEST_CASE_SEQUENCE = ['T351.R', 'T211.R'] #CANCELLED
# TEST_CASE_SEQUENCE = ['T351.R', 'T202.W'] #REJECTED
# TEST_CASE_SEQUENCE = ['T351.R', 'T202.W', 'T210.R'] #RESUBMITTED
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T203.W'] #INFOREQST
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T203.W', 'T204.R'] # INFOPROVD
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T203.W', 'T204.R', 'T205.W'] #VISITSCHED
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T224.W'] # PROCDELAY
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T352.W'] # COMPLETED
# TEST_CASE_SEQUENCE = ['T351.R', 'T201.W', 'T203.W', 'T204.R', 'T205.W', 'T206.W', 'T205.W', 'T224.W', 'T352.W', 'T208.R'] #CLOSED
# TEST_CASE_SEQUENCE = ['T351.R', 'T351.R', 'T201.W', 'T351.R', 'T211.R', 'T351.R', 'T202.W', 'T351.R', 'T202.W', 'T210.R', 'T351.R', 'T201.W', 'T203.W', 'T351.R', 'T201.W', 'T224.W', 'T351.R', 'T201.W', 'T352.W']
...
def generate_test_case_B5R(loop_times):
    ...
    for a in range(loop_times):
        ...
        for i in range(TEST_CASE_LENGTH):
            ...
            if ws11.cell(row=i+4+(a*TEST_CASE_LENGTH), column=5).value == 'T351.R':
