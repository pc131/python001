...
# TEST_CASE_SEQUENCE = ['T501.W'] # SUBMITTED
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W'] #ACCEPTED
# TEST_CASE_SEQUENCE = ['T501.W', 'T211.W'] #CANCELLED
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T222.W', 'T210.R'] #RESUBMITTED
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T222.W', 'T210.R', 'T202.W'] #REJECTED
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T217.W'] #INFOREQST
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T217.W', 'T218.R'] # INFOPROVD
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T222.W'] # COMPLETED
# TEST_CASE_SEQUENCE = ['T501.W', 'T201.W', 'T217.W', 'T218.R', 'T222.W', 'T208.R'] #CLOSED
TEST_CASE_SEQUENCE = ['T501.W', 'T501.W', 'T201.W', 'T501.W', 'T211.W', 'T501.W', 'T201.W', 'T222.W', 'T210.R', 'T202.W', 'T501.W', 'T201.W', 'T217.W', 'T501.W', 'T201.W', 'T222.W']
...
D8236 = ['EMAIL', 'TEL', 'BOTH'] # T321.R T321.W T351.R T351.W Customer Preferred Method of Contact
...
def generate_test_case_F5W(loop_times):
    new_filename = ''
    for a in range(loop_times):
        ...
        for i in range(TEST_CASE_LENGTH):
            ...
            if ws11.cell(row=i+4+(a*TEST_CASE_LENGTH), column=5).value == 'T501.W':
            ...
            match TEST_CASE_SEQUENCE[i]:
                case 'T501.W':
                    ...
                    for cols in range(10,19): # color request items
...
generate_test_case_F5W(max_loop)