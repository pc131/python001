...
filename = working_dir + "Bilaterals 1.9.0.1 master SRC DESTS.xlsx"
...
TEST_CASE_TRANSACTIONS = ['T339.R']


TRX_DATA_TEMS_COUNT = {'T201.W':2,'T202.W':4,'T203.W':3,'T204.R':2,'T205.W':4,'T206.W':3,'T207.R':2,'T207.W':2,'T208.R':2,'T210.R':3,'T211.R':3,'T211.W':3,'T212.W':2,'T213.W':5,'T214.W':3,'T215.R':5,'T215.W':5,'T216.R':2,'T216.W':2,'T217.W':4,'T218.R':25,'T220.W':2,'T221.R':2,'T222.W':9,'T223.W':26,'T224.W':3,'T225.R':4,'T225.W':4,'T226.W':3,'T227.R':2,'T228.R':2,'T321.R':133,'T321.W':110,'T322.W':91,'T323.W':7,'T324.R':2,'T325.R':2,'T331.W':24,'T332.W':29,'T335.R':76,'T336.W':64,'T341.R':102,'T341.W':79,'T342.W':11,'T351.R':53,'T351.W':30,'T352.W':29,'T353.R':42,'T355.R':48,'T355.W':25,'T356.W':12,'T357.W':28,'T365.R':51,'T501.R':35,'T501.W':12,'T505.R':31,'T505.W':8,'T551.R':30,'T551.W':7,'T555.R':39,'T555.W':16,'T556.R':50,'T556.W':28,'T557.W':5,'T561.R':44,'T561.W':21,'T562.R':57,'T562.W':34,'T563.W':5, 'T601.R':81, 'T601.W':58, 'T602.W':18}
...
PROC_NAMES = {
    ...
    'C4R':'Addition of Supply Point Components',
    'C4W':'Addition of Supply Point Components', 
...
TRANSACTION_NAMES = {
    ...
    'T339.R':'Application For Addition of Supply Point Components',
    'T339.W':'Application For Addition of Supply Point Components',
    'T340.W':'Advise Application Outcome For C4',
...
SUBMITTING_TRANSACTIONS = { 'T321.R', 'T321.W', 'T331.W', 'T335.R', 'T339.R', 'T339.W', 'T341.R', 'T341.W', 'T351.R', 'T351.W', 'T353.R', 'T355.R', 'T355.W', 'T365.R', 'T501.R', 'T501.W', 'T505.R', 'T505.W', 'T551.R', 'T551.W', 'T561.R', 'T561.W', 'T562.R', 'T562.W', 'T601.R', 'T601.W', 'TXC4.R', 'TXC4.W'}
...
C4R_TRANSACTIONS = ['T339.R', 'T201.W', 'T202.W', 'T203.W', 'T204.R', 'T205.W', 'T206.W', 'T207.R', 'T207.W', 'T208.R', 'T210.R', 'T211.R', 'T213.W', 'T214.W', 'T215.R', 'T215.W', 'T216.R', 'T216.W', 'T340.W']
C4R_T339R_allowed = ['T201.W', 'T202.W']
C4R_T201W_allowed = ['T203.W', 'T205.W', 'T340.W']
C4R_T202W_allowed = ['T210.R']
C4R_T203W_allowed = ['T204.R']
C4R_T204R_allowed = ['T203.W', 'T205.W', 'T340.W']
C4R_T205W_allowed = ['T203.W', 'T206.W', 'T340.W']
C4R_T206W_allowed = ['T203.W', 'T205.W']
C4R_T210R_allowed = ['T201.W', 'T202.W']
C4R_T340W_allowed = ['T208.R', 'T210.R']

C4W_TRANSACTIONS = ['T339.W', 'T201.W', 'T202.W', 'T217.W', 'T218.R', 'T205.W', 'T206.W', 'T207.R', 'T207.W', 'T208.R', 'T210.R', 'T211.R', 'T213.W', 'T214.W', 'T215.R', 'T215.W', 'T216.R', 'T216.W', 'T340.W']
C4W_T339W_allowed = ['T201.W']
C4W_T201W_allowed = ['T217.W', 'T205.W', 'T340.W']
C4W_T202W_allowed = ['T210.R']
C4W_T217W_allowed = ['T218.R']
C4W_T218R_allowed = ['T217.W', 'T205.W', 'T340.W']
C4W_T205W_allowed = ['T217.W', 'T206.W', 'T340.W']
C4W_T206W_allowed = ['T217.W', 'T205.W']
C4W_T210R_allowed = ['T201.W', 'T202.W']
C4W_T340W_allowed = ['T208.R', 'T210.R']
...
#C4
D8504 = ['MPW', 'MNPW', 'AW', 'UW', 'MS', 'AS', 'US', 'SW', 'HD']
D8506 = ['SCUPDATED', 'SCNOTUPDATED']
...
##############################################################################   
    for a in range(loop_times):
        ...
        T339R_data_items = [
                            #D2001 SPID
                            SPID, 
                            #D8504 Missing Service Component
                            'MPW', 
                            #D8505 Business Type
                            'Restaurant', 
        ...
        T340W_data_items = [
                            #D8221 ORID
                            '[orid]', 
                            #D8506 Complete Reason Code C4
                            'SCUPDATED', 
                            #D8507 SPID Not Updated Details
                            '',
                            #GROUP UPDATED SERVICE COMPONENTS (START)                             
                            #D8504 Service Component Type
                            'MPW', 
                            #D2076 Service Component Enabled
                            '1', 
                            #D8508 Assiigned Tariff Code
                            'TARIFF-01',
                            #D4006 Effective From Date
                            '[today]',
                            #GROUP UPDATED SERVICE COMPONENTS (END)   
                            #8505 Business Type
                            'Restaurant',
                            #D8351 Follow on Request ORID
                            '',
                            ...
                            '1',
                            #D8410 Charge to Retailer Reason
                            'We charge the Retailers, because we can',                            
                            #D8213 Additional Information
                            fake.paragraph(nb_sentences=1)
                            ]                       
        T341R_data_items = [
        ...
        T601R_data_items = [
                            ...
                            'SWAREACHANGE', # FIREFIGHTING, LEAK, VOLUMEADJST, NONRTSCHANGE, SWAREACHANGE
            ...
            match test_case_sequence[i]:
                ...
                case 'T339.R':
                    ...
                    for col_range in range(7, 20):
                        ...
                        cell_title.fill = PatternFill(start_color="A3E4D7", end_color="A3E4D7", fill_type="solid")
                    #CUSTOMER BLOCK 21        
                    for col_range in range(20, 41):
                        cell_title = ws12.cell(4+(3*i)+(3*a*TEST_CASE_LENGTH), col_range)
                        cell_title.fill = PatternFill(start_color="D6EAF8", end_color="D6EAF8", fill_type="solid")                    
                    for k in range(len(T339R_data_items)):
                        ws12.cell(row=6+(3*i)+(3*a*TEST_CASE_LENGTH), column=k +
                                7).value = T339R_data_items[k]  
                case 'T339.W':
                    #coloring header cells to distinguish data blocks
                    #SPID 30
                    for col_range in range(7, 18):
                        cell_title = ws12.cell(4+(3*i)+(3*a*TEST_CASE_LENGTH), col_range)
                        cell_title.fill = PatternFill(start_color="A3E4D7", end_color="A3E4D7", fill_type="solid")                  
                    for k in range(len(T339W_data_items)):
                        ws12.cell(row=6+(3*i)+(3*a*TEST_CASE_LENGTH), column=k +
                                7).value = T339W_data_items[k]
                case 'T340.W':
                    #coloring header cells to distinguish data blocks
                    #SPID 3
                    for col_range in range(7, 11):
                        cell_title = ws12.cell(4+(3*i)+(3*a*TEST_CASE_LENGTH), col_range)
                        cell_title.fill = PatternFill(start_color="A3E4D7", end_color="A3E4D7", fill_type="solid")
                    #Group Updated Service Components 4
                    for col_range in range(11, 15):
                        cell_title = ws12.cell(4+(3*i)+(3*a*TEST_CASE_LENGTH), col_range)
                        cell_title.fill = PatternFill(start_color="A1E4CC", end_color="A1E4CC", fill_type="solid")                        
                    #Remaining 4        
                    for col_range in range(15, 20):
                        cell_title = ws12.cell(4+(3*i)+(3*a*TEST_CASE_LENGTH), col_range)
                        cell_title.fill = PatternFill(start_color="D6EAF8", end_color="D6EAF8", fill_type="solid")                    
                    for k in range(len(T340W_data_items)):
                        ws12.cell(row=6+(3*i)+(3*a*TEST_CASE_LENGTH), column=k +
                                7).value = T340W_data_items[k]                                                                     
                case 'T341.R':
                    #coloring header cells to distinguish data blocks
                    #SPID
                    for col_range in range(7, 11):
