...
TEST_CASE_SEQUENCE = ['T551.W'] # SUBMITTED
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W'] #ACCEPTED
# TEST_CASE_SEQUENCE = ['T551.W', 'T211.W'] #CANCELLED
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T222.W', 'T210.R'] #RESUBMITTED
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T222.W', 'T210.R', 'T202.W'] #REJECTED
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T217.W'] #INFOREQST
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T217.W', 'T218.R'] # INFOPROVD
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T222.W'] # COMPLETED
# TEST_CASE_SEQUENCE = ['T551.W', 'T201.W', 'T217.W', 'T218.R', 'T222.W', 'T208.R'] #CLOSED
# TEST_CASE_SEQUENCE = ['T551.W', 'T551.W', 'T201.W', 'T551.W', 'T211.W', 'T551.W', 'T201.W', 'T222.W', 'T210.R', 'T202.W', 'T551.W', 'T201.W', 'T217.W', 'T551.W', 'T201.W', 'T222.W']
...
def generate_test_case_G1W(loop_times):
    new_filename = ''
    for a in range(loop_times):
        ...
        for i in range(TEST_CASE_LENGTH):
            ...
            if ws11.cell(row=i+4+(a*TEST_CASE_LENGTH), column=5).value == 'T551.W':
            ...
            match TEST_CASE_SEQUENCE[i]:
                case 'T551.W':
                    ...
                    for cols in range(10,14): # color request items
...
generate_test_case_G1W(max_loop)