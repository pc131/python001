...
def pick_spid_meter():
    spid_meter = random.choice(list(SPIDS_METERS2.items()))
    spid = spid_meter[0]
    meter_mnf = spid_meter[1][0]
    meter_ser = spid_meter[1][1]
    return spid, meter_mnf, meter_ser
...
D8326 = ['CHGTYPE', 'CGHSSIZE', 'CGHLSIZE', 'CHGLOC'] # T365.R
D8326 = ['NEWINSTALL', 'CHGNEW', 'LOCCHGNEW', 'LOCCHGEXG', 'UNFEASIBLE'] # T223.W
...
def generate_test_case_C1R(type, loop_times):
    new_filename = ''
